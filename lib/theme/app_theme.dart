...
const Map<String, IconData> kCategoryIconChoices = {
  ...
  // ── Extended set ──────────────────────────────────────────────────────────
  // Money / shopping
  'cartbadgeplus': CupertinoIcons.cart_badge_plus,
  'bagbadgeplus': CupertinoIcons.bag_badge_plus,
  'cubefill': CupertinoIcons.cube_box_fill,
  'percent': CupertinoIcons.percent,
  'chartbarfill': CupertinoIcons.chart_bar_fill,
  'bitcoincircle': CupertinoIcons.bitcoin_circle,
  'moneyfill': CupertinoIcons.money_dollar_circle_fill,
  'rubl': CupertinoIcons.money_rubl,
  'ticket': CupertinoIcons.tickets_fill,
  'graph': CupertinoIcons.graph_square,
  // Transport / travel
  'carfill': CupertinoIcons.car_fill,
  'rocket': CupertinoIcons.rocket,
  'rocketfill': CupertinoIcons.rocket_fill,
  'placemark': CupertinoIcons.placemark,
  'mapfill': CupertinoIcons.map_fill,
  'locationfill': CupertinoIcons.location_fill,
  // Home / utilities / weather
  'boltfill': CupertinoIcons.bolt_fill,
  'flamefill': CupertinoIcons.flame_fill,
  'dropfill': CupertinoIcons.drop_fill,
  'snow': CupertinoIcons.snow,
  'wind': CupertinoIcons.wind,
  'lightbulbfill': CupertinoIcons.lightbulb_fill,
  'phonefill': CupertinoIcons.phone_fill_badge_plus,
  'sunrise': CupertinoIcons.sunrise_fill,
  'moonstars': CupertinoIcons.moon_stars_fill,
  'cloudrain': CupertinoIcons.cloud_rain_fill,
  'sparkles': CupertinoIcons.sparkles,
  // Entertainment / media
  'filmfill': CupertinoIcons.film_fill,
  'tvfill': CupertinoIcons.tv_fill,
  'camerafill': CupertinoIcons.camera_fill,
  'video': CupertinoIcons.videocam,
  'videofill': CupertinoIcons.videocam_fill,
  'micfill': CupertinoIcons.mic_fill,
  'speaker': CupertinoIcons.speaker_2_fill,
  'gamefill': CupertinoIcons.game_controller_solid,
  'bookfill': CupertinoIcons.book_fill,
  // Health / personal
  'heartcircle': CupertinoIcons.heart_circle_fill,
  'personfill': CupertinoIcons.person_fill,
  'peoplefill': CupertinoIcons.person_2_fill,
  'familyfill': CupertinoIcons.person_3_fill,
  'starcircle': CupertinoIcons.star_circle_fill,
  'flagfill': CupertinoIcons.flag_fill,
  'bandagefill': CupertinoIcons.bandage_fill,
  // Work / tools / time
  'briefcasefill': CupertinoIcons.briefcase_fill,
  'docfill': CupertinoIcons.doc_fill,
  'mailfill': CupertinoIcons.mail_solid,
  'chatfill': CupertinoIcons.chat_bubble_2_fill,
  'settings': CupertinoIcons.settings,
  'shield': CupertinoIcons.shield_fill,
  'lockopen': CupertinoIcons.lock_open_fill,
  'bellfill': CupertinoIcons.bell_fill,
  'clockfill': CupertinoIcons.clock_fill,
  'alarm': CupertinoIcons.alarm_fill,
